...
public class SkyRankBulletin extends JFrame implements KeyListener {
	...
	public SkyRankBulletin() {
		...
		try {
			...
			InputStreamReader isr = new InputStreamReader(new FileInputStream("txt/SkyRank.csv"));
			...
			// JLabel - ScoreTitle
			 ...
			 for(int n=0 ; n<nLabel.length; n++) {
				 ...
				 nLabel[n].setBounds(20, 135+68*n, 100, 35);
			 ...
			 for(int n=0 ; n<10 ; n++) {
				 ...
				 pnLabel[n].setBounds(140, 135+68*n, 135, 35);
				 pnLabel[n].setFont(new java.awt.Font("標楷體", 1, 30));
			...
			//JLabel - PlayerScore
			 ...
			 for(int n=0 ; n<10 ; n++) {
				 ...
				 psLabel[n].setBounds(295, 135+68*n, 250, 35);
			 ...
			 for(int n=0 ; n<10 ; n++) {
				 ...
				 pdLabel[n].setBounds(495, 135+68*n, 250, 35);
